...
def json_to_md(filename,md_filename,
    ...
    with open(md_filename,"a+") as f:
        ...
        if use_title == True:
            #f.write(("<p align="center"><h1 align="center"><br><ins>ai4polymere-ARXIV-DAILY"
            #         "</ins><br>Automatically Update ai4polymere Papers Daily</h1></p>\n"))
