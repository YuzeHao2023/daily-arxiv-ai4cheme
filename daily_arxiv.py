...
def json_to_md(filename,md_filename,
    ...
    with open(md_filename,"a+") as f:
        ...
        if use_title == True:
            #f.write(("<p align="center"><h1 align="center"><br><ins>ai4cheme-ARXIV-DAILY"
            #         "</ins><br>Automatically Update ai4cheme Papers Daily</h1></p>\n"))
